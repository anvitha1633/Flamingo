...
"Let me confirm that for you in a moment — could you please share your preferred date and service to our receptionist at +918296584278?"
...
app.post("/book", async (req, res) => {
    try {
        ...
        // Optional: include UID if provided by frontend
        if (req.body.customerUid) {
            newBooking.customerUid = req.body.customerUid;
        }
